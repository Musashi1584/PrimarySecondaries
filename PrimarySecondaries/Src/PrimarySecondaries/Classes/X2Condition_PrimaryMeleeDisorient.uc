...
event name CallAbilityMeetsCondition(XComGameState_Ability kAbility, XComGameState_BaseObject kTarget) 
{
	...
	if (SourceWeapon == none || !class'X2DownloadableContentInfo_PrimarySecondaries'.static.IsPrimaryMeleeWeaponTemplate(X2WeaponTemplate(SourceWeapon.GetMyTemplate())))
	{ 
